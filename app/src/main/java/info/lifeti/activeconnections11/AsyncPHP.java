...
public class AsyncPHP extends AsyncTask<String,Void,String> {
    ...
    protected void onPreExecute() {
        ...
        alertDialog.setTitle("Lista Usuários");
    ...
    protected String doInBackground(String... params) {
        String reg_url = "http://192.168.1.20/webapp/register.php";
        String login_url = "http://192.168.1.20/webapp/login.php";
        String lista_url = "http://192.168.1.20/webapp/lista.php";
